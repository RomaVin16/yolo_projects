...
### Модель
- **Архитектура:** YOLOv11n-seg (нано-версия)
- **Задача:** Одновременная детекция и сегментация 12 грудных позвонков
...
# Рекомендуемые параметры на основе анализа кривых F1
...
|----------------------|----------------------|
| ![Оригинал 1](images/before_1.jpg) | ![Результат 1](images/after_1.jpg) |

**Анализ:** Модель корректно определила все 12 позвонков (T1-T12), точность локализации высокая.

---

### Пример 2: Снимок с низким контрастом
| Исходное изображение | Результат сегментации |
|----------------------|----------------------|
| ![Оригинал 2](images/before_2.jpg) | ![Результат 2](images/after_2.jpg) |

**Анализ:** Несмотря на плохую видимость, модель обнаружила 11 из 12 позвонков.
...
| Исходное изображение | Результат сегментации |
|----------------------|----------------------|
| ![Оригинал 3](images/before_3.jpg) | ![Результат 3](images/after_3.jpg) |

**Анализ:** Модель успешно адаптировалась к новому источнику данных.
